...
| `issue_tracker` — Issue tracker linkage from intake (intake, step 4) | The spec is promoted and archived normally; no ticket is created, linked, or updated from the inbox doc | "no issue tracker configured — ticket linkage skipped" printed at step 4; intake continues to archive the inbox doc | Configure an issue tracker integration; add a tracker-sync skill to your plugin and call it from intake step 4 after the spec is frozen |
